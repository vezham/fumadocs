...
[Heading IDs](https://www.example.com/docs#handbook)
```

[Heading IDs](/docs)

<mark>Note:</mark> Other websites can link to the heading by adding the custom heading ID to the full URL of the webpage (e.g, [Heading IDs](https://www.markdownguide.org/extended-syntax#heading-ids)).
...
<mark>Note:</mark> Cell widths can vary, as shown below. The rendered output will look the same.
...
<mark>Note:</mark> [Emoji cheatsheet](https://github.com/ikatyang/emoji-cheat-sheet/blob/master/README.md#smileys--emotion), 
...
<mark>Note:</mark> [list of emoji shortcodes](https://gist.github.com/rxaviers/7360908)
```html

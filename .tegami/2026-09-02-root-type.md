---
packages:
  npm:@vx-oss/docs-core: patch
  npm:@vx-oss/docs-radix-ui: patch
  npm:@vx-oss/docs-base-ui: patch
---
...
## `findProjection()` in `@vx-oss/docs-core/page-tree`
...
```ts
import { findProjection } from '@vx-oss/docs-core/page-tree';

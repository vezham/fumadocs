---
packages:
  npm:@vezham/docs-core: patch
  npm:@vezham/docs-react: patch
...
## `findProjection()` in `@vezham/docs-core/page-tree`
...
```ts
import { findProjection } from '@vezham/docs-core/page-tree';

...
Enable the notebook layout with `@vezham/docs-react/layouts/notebook`.

```tsx title="layout.tsx"
import { DocsLayout } from '@vezham/docs-react/layouts/notebook'; // [!code highlight]
...
import { ... } from '@vezham/docs-react/layouts/notebook/page'; // [!code ++]
```

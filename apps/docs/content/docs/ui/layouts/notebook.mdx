...
Enable the notebook layout with `@vx-oss/docs-react/layouts/notebook`.

```tsx title="layout.tsx"
import { DocsLayout } from '@vx-oss/docs-react/layouts/notebook'; // [!code highlight]
...
import { ... } from '@vx-oss/docs-react/layouts/notebook/page'; // [!code ++]
```

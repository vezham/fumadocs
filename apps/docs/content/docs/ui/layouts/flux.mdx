...
Enable the Flux layout with `@vx-oss/docs-react/layouts/flux`.

```tsx title="layout.tsx"
import { DocsLayout } from '@vx-oss/docs-react/layouts/flux'; // [!code highlight]
...
import { ... } from '@vx-oss/docs-react/layouts/flux/page'; // [!code ++]
```

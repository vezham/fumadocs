...
Enable the Flux layout with `@vezham/docs-react/layouts/flux`.

```tsx title="layout.tsx"
import { DocsLayout } from '@vezham/docs-react/layouts/flux'; // [!code highlight]
...
import { ... } from '@vezham/docs-react/layouts/flux/page'; // [!code ++]
```

...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from '@vezham/docs-react/layouts/docs/page';
...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from '@vezham/docs-react/layouts/notebook/page';
...
```tsx
import { DocsPage, ViewOptionsPopover } from '@vezham/docs-react/layouts/<layout>/page';
...
```tsx
import { DocsPage, PageLastUpdate } from '@vezham/docs-react/layouts/<layout>/page';
...
```tsx
import { getGithubLastEdit } from '@vezham/docs-core/content/github';
...
```tsx
import { DocsPage } from '@vezham/docs-react/layouts/<layout>/page';
...
<auto-type-table type="import('@vezham/docs-react/layouts/docs/page/slots/toc').TOCProps" />
...
import type {
  ...
  TOCPopoverProps,
  TOCProviderProps,
} from '@vezham/docs-react/layouts/<layout>/page/slots/toc';
...
<auto-type-table type="Omit<import('@vezham/docs-react/layouts/docs/page').FooterProps, keyof React.ComponentProps<'div'>>" />
...
'use client';
import type { FooterProps } from '@vezham/docs-react/layouts/<layout>/page/slots/footer';
...
<auto-type-table type="Omit<import('@vezham/docs-react/layouts/docs/page').BreadcrumbProps, keyof React.ComponentProps<'div'>>" />
...
'use client';
import type { BreadcrumbProps } from '@vezham/docs-react/layouts/<layout>/page/slots/breadcrumb';

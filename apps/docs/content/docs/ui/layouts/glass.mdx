...
Enable the Glass layout with `@vezham/docs-react/layouts/glass`.

```tsx title="layout.tsx"
import { GlassLayout } from '@vezham/docs-react/layouts/glass'; // [!code highlight]
...
```tsx title="page.tsx"
import { ... } from '@vezham/docs-react/layouts/docs/page'; // [!code --]
import { ... } from '@vezham/docs-react/layouts/glass/page'; // [!code ++]
```
...
@import 'tailwindcss';
/* [!code ++] */
@import '@vezham/docs-react/css/generated/glass.css';
@import '@vezham/docs-react/css/neutral.css';

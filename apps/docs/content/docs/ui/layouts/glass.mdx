...
Enable the Glass layout with `@vx-oss/docs-react/layouts/glass`.

```tsx title="layout.tsx"
import { GlassLayout } from '@vx-oss/docs-react/layouts/glass'; // [!code highlight]
...
```tsx title="page.tsx"
import { ... } from '@vx-oss/docs-react/layouts/docs/page'; // [!code --]
import { ... } from '@vx-oss/docs-react/layouts/glass/page'; // [!code ++]
```
...
@import 'tailwindcss';
/* [!code ++] */
@import '@vx-oss/docs-react/css/generated/glass.css';

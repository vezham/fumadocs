...
Base UI is the default component library. If you install manually, alias `@vezham/docs-react` to the `@fumadocs/base-ui` package:

```json title="package.json"
{
  "dependencies": {
    "@vezham/docs-react": "npm:@fumadocs/base-ui@latest",
...
You can opt-in to use Radix UI by installing the `@vezham/docs-react` package directly:

```json title="package.json"
{
  "dependencies": {
    "@vezham/docs-react": "latest"
  }
}
```

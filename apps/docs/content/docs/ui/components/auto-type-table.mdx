...
```npm
npm i @vx-oss/docs-typescript
```

Initialize the TypeScript compiler and add it as a MDX component.

```tsx title="components/mdx.tsx"
import defaultComponents from '@vx-oss/docs-react/mdx';
import type { MDXComponents } from 'mdx/types';
import { createGenerator, createFileSystemGeneratorCache } from '@vx-oss/docs-typescript';
import { AutoTypeTable, type AutoTypeTableProps } from '@vx-oss/docs-typescript/ui';

...
import { defineTranslations } from '@vx-oss/docs-core/i18n';
...
Language packs provide translations for `@vx-oss/docs-react` and several other integrations like Fumadocs OpenAPI.

```npm
npm i @vx-oss/docs-language
```
...
import * as OpenAPI from '@vx-oss/docs-openapi/i18n';
import * as UI from '@vx-oss/docs-react/i18n';
import * as Story from '@vx-oss/docs-story/i18n';

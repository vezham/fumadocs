...
import { defineTranslations } from '@vezham/docs-core/i18n';
...
```tsx
import { RootProvider } from '@vezham/docs-react/provider/<framework>';
...
Language packs provide translations for `@vezham/docs-react` and several other integrations like Fumadocs OpenAPI.
...
import * as OpenAPI from '@vezham/docs-openapi/i18n';
import * as UI from '@vezham/docs-react/i18n';
import * as Story from '@vezham/docs-story/i18n';

---
title: Macro API
description: Define collections in your app with @vezham/docs-mdx/macro.
---

## Overview

Declare collections directly in your application modules with `@vezham/docs-mdx/macro`.
...
- Re-exporting from `@vezham/docs-mdx/macro` is not supported.

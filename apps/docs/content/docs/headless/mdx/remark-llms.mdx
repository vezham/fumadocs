...
import { defineDocs } from '@vezham/docs-mdx/config';
import { type LLMsOptions } from '@vezham/docs-core/mdx-plugins/remark-llms';
...
import { remarkLLMs, type LLMsOptions } from '@vezham/docs-core/mdx-plugins/remark-llms';
...
Otherwise, render it with `renderToMarkdown` from `@vezham/docs-core/server`, elements resolve from `props.components`:

```tsx
import { renderToMarkdown } from '@vezham/docs-core/server';
...
```tsx
import { asMarkdown, md } from '@vezham/docs-core/server';
...
```ts
import { placeholder, type LLMsOptions } from '@vezham/docs-core/mdx-plugins/remark-llms';
...
```ts
import { renderPlaceholder } from '@vezham/docs-core/mdx-plugins/remark-llms.runtime';
...
<auto-type-table
  type="import('@vezham/docs-core/mdx-plugins/remark-llms').LLMsOptions"
/>

...
import { type LLMsOptions } from '@vx-oss/docs-core/mdx-plugins/remark-llms';
...
import { remarkLLMs, type LLMsOptions } from '@vx-oss/docs-core/mdx-plugins/remark-llms';
...
Otherwise, render it with `renderToMarkdown` from `@vx-oss/docs-core/server`, elements resolve from `props.components`:

```tsx
import { renderToMarkdown } from '@vx-oss/docs-core/server';
...
```tsx
import { asMarkdown, md } from '@vx-oss/docs-core/server';
...
```ts
import { placeholder, type LLMsOptions } from '@vx-oss/docs-core/mdx-plugins/remark-llms';
...
```ts
import { renderPlaceholder } from '@vx-oss/docs-core/mdx-plugins/remark-llms.runtime';
...
<auto-type-table
  type="import('@vx-oss/docs-core/mdx-plugins/remark-llms').LLMsOptions"
/>

...
```ts
import { createShikiFactory } from '@vx-oss/docs-core/highlight/shiki';
...
'use client';
import * as Base from '@vx-oss/docs-react/dynamic-codeblock.core';
...
import { createRehypeCode } from '@vx-oss/docs-core/mdx-plugins/rehype-code.core';

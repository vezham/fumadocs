...
```ts
import { createShikiFactory } from '@vezham/docs-core/highlight/shiki';
...
'use client';
import * as Base from '@vezham/docs-react/dynamic-codeblock.core';
...
import { createRehypeCode } from '@vezham/docs-core/mdx-plugins/rehype-code.core';

...
import { createSearchAPI } from '@vezham/docs-core/search/server';
...
<auto-type-table type='import("@vezham/docs-core/search/client/fetch").FetchOptions' />
...
- **Search Client**: use `staticClient` instead of `fetchClient`.
  ...
  <auto-type-table type='import("@vezham/docs-core/search/client/orama-static").StaticOptions' />
...
import { source } from '@/lib/source';
import { createI18nSearchAPI } from '@vezham/docs-core/search/server';
...
```ts
import { initAdvancedSearch } from '@vezham/docs-core/search/server';

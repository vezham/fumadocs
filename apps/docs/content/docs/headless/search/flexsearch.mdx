...
```ts title="app/api/search/route.ts (Next.js)"
import { source } from '@/lib/source';
import { flexsearch } from '@vx-oss/docs-core/search/flexsearch';
...
- **Search Client**: change your client adapter.
  ...
  <auto-type-table type='import("@vx-oss/docs-core/search/client/flexsearch-static").FlexsearchStaticOptions' />
...
import { source } from '@/lib/source';
import { flexsearchI18n } from '@vx-oss/docs-core/search/flexsearch';

...
```ts title="app/api/search/route.ts (Next.js)"
import { source } from '@/lib/source';
import { flexsearch } from '@vezham/docs-core/search/flexsearch';
...
- **Search Client**: change your client adapter.
  ...
  <auto-type-table type='import("@vezham/docs-core/search/client/flexsearch-static").FlexsearchStaticOptions' />
...
import { source } from '@/lib/source';
import { flexsearchI18n } from '@vezham/docs-core/search/flexsearch';

...
```npm
npm i @vx-oss/docs-asyncapi shiki
```
...
/* [!code ++] */
@import '@vx-oss/docs-asyncapi/css/preset.css';
```
...
import { asyncapiPlugin } from '@vx-oss/docs-asyncapi/server';
...
import { generateFiles } from '@vx-oss/docs-asyncapi';

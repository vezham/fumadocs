...
} from '@vx-oss/docs-openapi/requests/generators';
import { registerDefault } from '@vx-oss/docs-openapi/requests/generators/all';
...
'use client';
import { createOpenAPIPage } from '@vx-oss/docs-openapi/ui';
import type { MediaAdapter } from '@vx-oss/docs-openapi';
...
The installed files access the runtime of API pages from `@vx-oss/docs-openapi/ui`, such as the render context. You can also use it to build your own playground from scratch.

...
} from '@vezham/docs-openapi/requests/generators';
import { registerDefault } from '@vezham/docs-openapi/requests/generators/all';
...
'use client';
import { createOpenAPIPage } from '@vezham/docs-openapi/ui';
import type { MediaAdapter } from '@vezham/docs-openapi';
...
The installed files access the runtime of API pages from `@vezham/docs-openapi/ui`, such as the render context. You can also use it to build your own playground from scratch.

...
```npm
npx @vx-oss/docs-cli add fumadocs/sanity/base
```

> Or you can run `npx @vx-oss/docs-cli add` and browse additional Sanity presets to install.
...
```tsx
import { getSource } from '@/lib/source';
import { renderToc } from '@vx-oss/docs-sanity/client';
import { CustomPortableText } from '@/components/sanity';
import { DocsPage, DocsBody, DocsDescription, DocsTitle } from '@vx-oss/docs-react/layouts/docs/page';

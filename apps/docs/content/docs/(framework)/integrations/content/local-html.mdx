...
`@vx-oss/docs-local-html` is a content source for local HTML files, it is bundleless (works fully at runtime) by design.
...
import { DocsPage, DocsBody, DocsTitle, DocsDescription } from '@vx-oss/docs-react/page';
...
import { localContentPlugin } from '@vx-oss/docs-local-html/dev/vite';
...
import { watchWithVite } from '@vx-oss/docs-local-html/dev/vite';

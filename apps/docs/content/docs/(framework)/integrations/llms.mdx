...
import { rewritePath } from '@vx-oss/docs-core/negotiation';
...
```npm
npx @vx-oss/docs-cli add ai/page-actions
```
...
```npm
npx @vx-oss/docs-cli add ai/openrouter
```
...
```npm
npx @vx-oss/docs-cli add ai/llmgateway
```
...
```npm
npx @vx-oss/docs-cli add ai/inkeep
```

...
I love to have fewer files, but considering `create-vx-oss-docs` should also act as a starting point for beginners who may not be familiar with MDX, it's much more helpful to provide it by default.

...
We have a few built-in integrations, like `@vx-oss/docs-openapi` which takes an OpenAPI schema and output MDX files.
...
The entire release process is handled by [Changesets](https://github.com/changesets/changesets), and I wrote the scripts to update [the template repository](https://github.com/fuma-nama/@vx-oss/docs-react-template) automatically.

...
Add `@import` to the presets exported by Fumadocs UI, and include the `@vezham/docs-react` package in the source.
...
@source '../node_modules/@vezham/docs-react/dist/**/*.js';
```
...
import { APIPlayground } from '@vezham/docs-openapi/scalar';

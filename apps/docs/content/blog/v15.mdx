...
Add `@import` to the presets exported by Fumadocs UI, and include the `@vx-oss/docs-react` package in the source.
...
@source '../node_modules/@vx-oss/docs-react/dist/**/*.js';
```
...
import { APIPlayground } from '@vx-oss/docs-openapi/scalar';

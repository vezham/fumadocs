...
The `@vx-oss/docs-openapi/ui/client` subpath export is removed. Merge any `defineClientConfig()` options into `createOpenAPIPage()` directly.

```tsx tab="Before" title="components/api-page.tsx"
import { openapi } from '@/lib/openapi';
import { createAPIPage } from '@vx-oss/docs-openapi/ui';
...
'use client';
import { defineClientConfig } from '@vx-oss/docs-openapi/ui/client';
...
```tsx tab="Before"
import { createCodeSample } from '@vx-oss/docs-openapi/server';
...
import { transformerOpenAPI } from '@vx-oss/docs-openapi/server';
...
import { openapiPlugin } from '@vx-oss/docs-openapi/server';

...
The `@vezham/docs-openapi/ui/client` subpath export is removed. Merge any `defineClientConfig()` options into `createOpenAPIPage()` directly.

```tsx tab="Before" title="components/api-page.tsx"
import { openapi } from '@/lib/openapi';
import { createAPIPage } from '@vezham/docs-openapi/ui';
...
'use client';
import { defineClientConfig } from '@vezham/docs-openapi/ui/client';
...
```tsx tab="Before"
import { createCodeSample } from '@vezham/docs-openapi/server';
...
import { transformerOpenAPI } from '@vezham/docs-openapi/server';
...
import { openapiPlugin } from '@vezham/docs-openapi/server';

...
<Callout title="Note">
  At present, Fumadocs MDX depends solely on the remark and rehype plugins from `@vx-oss/docs-core`.
</Callout>
...
- **No Framework Defaults:** the MDX preset of Fumadocs will be offered by `@vx-oss/docs-core`, likely as a Fuma Content plugin.

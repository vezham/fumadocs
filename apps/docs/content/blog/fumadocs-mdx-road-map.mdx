...
<Callout title="Note">
  At present, Fumadocs MDX depends solely on the remark and rehype plugins from `@vezham/docs-core`.
</Callout>
...
- **No Framework Defaults:** the MDX preset of Fumadocs will be offered by `@vezham/docs-core`, likely as a Fuma Content plugin.

...
/* [!code ++] */
@import '@vx-oss/docs-react/css/preset-legacy.css';
```
...
- `@vx-oss/docs-react/contexts/sidebar`
- `@vx-oss/docs-react/contexts/layout`

If you have already installed `<DocsLayout />` via Fumadocs CLI, import the legacy contexts instead:

```ts
// [!code --:2]
import {} from '@vx-oss/docs-react/contexts/sidebar';
import {} from '@vx-oss/docs-react/contexts/layout';

// [!code ++:2]
import {} from '@vx-oss/docs-react/legacy/sidebar';
import {} from '@vx-oss/docs-react/legacy/layout';
```
...
import { SidebarProvider } from '@vx-oss/docs-react/legacy/sidebar';
...
import layout components (e.g. `<DocsLayout />`) from `@vx-oss/docs-react`, migrate your usages as follows:

```tsx
// [!code --]
import { useSidebar } from '@vx-oss/docs-react/contexts/sidebar';
// [!code ++]
...
```ts
// For docs layout
import { DocsPage } from '@vx-oss/docs-react/layouts/docs/page';
// For notebook layout
import { DocsPage } from '@vx-oss/docs-react/layouts/notebook/page';
```

**Migration Steps:** Update your imports accordingly. Although the default `@vx-oss/docs-react/page` will redirect to the correct layout, we strongly advise explicit imports for clarity and future-proofing.

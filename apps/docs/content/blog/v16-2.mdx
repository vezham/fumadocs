...
/* [!code --] */
@import '@vezham/docs-react/css/preset.css';
/* [!code ++] */
@import '@vezham/docs-react/css/preset-legacy.css';
```
...
- `@vezham/docs-react/contexts/sidebar`
- `@vezham/docs-react/contexts/layout`

If you have already installed `<DocsLayout />` via Fumadocs CLI, import the legacy contexts instead:

```ts
// [!code --:2]
import {} from '@vezham/docs-react/contexts/sidebar';
import {} from '@vezham/docs-react/contexts/layout';

// [!code ++:2]
import {} from '@vezham/docs-react/legacy/sidebar';
import {} from '@vezham/docs-react/legacy/layout';
```
...
import { SidebarProvider } from '@vezham/docs-react/legacy/sidebar';
...
import layout components (e.g. `<DocsLayout />`) from `@vezham/docs-react`, migrate your usages as follows:

```tsx
// [!code --]
import { useSidebar } from '@vezham/docs-react/contexts/sidebar';
// [!code ++]
...
```ts
// For docs layout
import { DocsPage } from '@vezham/docs-react/layouts/docs/page';
// For notebook layout
import { DocsPage } from '@vezham/docs-react/layouts/notebook/page';
```

**Migration Steps:** Update your imports accordingly. Although the default `@vezham/docs-react/page` will redirect to the correct layout, we strongly advise explicit imports for clarity and future-proofing.

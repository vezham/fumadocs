...
- **A better versioning policy:** Reduce abstraction for mitigating upstream changes, instead version the components directly (e.g. creating a new `@vx-oss/docs-react/layouts/v2/page` instead of a major UI change).

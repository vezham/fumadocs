...
```package-install
npm install @vx-oss/docs-cli --save-dev
```
...
import { oramaStaticClient } from '@vx-oss/docs-core/search/client/orama-static';
...
import { createMetadataImage } from '@vx-oss/docs-core/server';
import { source } from '@/lib/source';
...
In favour of this, the `getImageMeta` function from `@vx-oss/docs-react/og` has been removed.
...
```tsx title="page.tsx"
import { source } from '@/lib/source';
import { DocsCategory } from '@vx-oss/docs-react/page';
...
```ts
import { defineDocs } from '@vx-oss/docs-mdx/config';
...
```ts
import { DocsLayout } from '@vx-oss/docs-react/layout';
import { HomeLayout } from '@vx-oss/docs-react/home-layout';
import { HomeLayoutProps } from '@vx-oss/docs-react/home-layout';
```
...
We moved Twoslash UI components to `@vx-oss/docs-twoslash`.
...
The types from `@vx-oss/docs-core/search/shared` is moved to `@vx-oss/docs-core/server`.

...
import { oramaStaticClient } from '@vezham/docs-core/search/client/orama-static';
...
import { createMetadataImage } from '@vezham/docs-core/server';
import { source } from '@/lib/source';
...
In favour of this, the `getImageMeta` function from `@vezham/docs-react/og` has been removed.
...
```tsx title="page.tsx"
import { source } from '@/lib/source';
import { DocsCategory } from '@vezham/docs-react/page';
...
```ts
import { DocsLayout } from '@vezham/docs-react/layout';
import { HomeLayout } from '@vezham/docs-react/home-layout';
import { HomeLayoutProps } from '@vezham/docs-react/home-layout';
```
...
The types from `@vezham/docs-core/search/shared` is moved to `@vezham/docs-core/server`.

...
import { toFumadocsSource } from '@vx-oss/docs-mdx/runtime/server';
import { loader } from '@vx-oss/docs-core/source';
...
// or
import { postInstall } from '@vx-oss/docs-mdx/vite';
...
import { defineCollections, getDefaultMDXOptions } from '@vx-oss/docs-mdx/config';
...
import { defineCollections, applyMdxPreset } from '@vx-oss/docs-mdx/config';
import { myPlugin } from './remark-plugin';
...
import mdx from '@vx-oss/docs-mdx/vite';

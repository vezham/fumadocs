...
export interface StoryOptions<C extends FC<any>> {
  ...
  /**
   * Controls & data generated at build time by `@vx-oss/docs-story/vite` or `@vx-oss/docs-story/next`.
   *
   * @internal
   */
  _generated?: {
        ...
        return {
          ...
          presets: normalized.map((preset) => {
            ...
            if (preset.controls && 'node' in preset.controls) {
              ...
              throw new Error(
                `[@vx-oss/docs-story] No generated data for story, make sure the Vite plugin or Turbopack loader is configured correctly`,
              );
            }

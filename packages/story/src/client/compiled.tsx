...
export interface StoryOptions<C extends FC<any>> {
  ...
  /**
   * Controls & data generated at build time by docs-story's Vite plugin or Next loader.
   *
   * @internal
   */
  _generated?: {
        ...
        return {
          ...
          presets: normalized.map((preset) => {
            ...
            if (preset.controls && 'node' in preset.controls) {
              ...
              throw new Error(
                `[docs-story] No generated data for story, make sure the Vite plugin or Turbopack loader is configured correctly`,
              );
            }
